     ...
     <div class="main-panel">        
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
              Add ULB Calculation Details
            </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">ULB Details</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add ULB Calculation Details</li>
                </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add ULB Calculation Details</h4>
                  <p class="card-description">
                    Please Fill the Details
                  </p>
                  <!-- Details need to edit -->
